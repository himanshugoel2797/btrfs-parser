...
#define BTRFS_SuperblockOffset0 (64ull * 1024)
#define BTRFS_SuperblockOffset1 (64ull * 1024 * 1024)
#define BTRFS_SuperblockOffset2 (256ull * 1024 * 1024 * 1024)
#define BTRFS_SuperblockOffset3 (1024ull * 1024 * 1024 * 1024 * 1024)

static uint64_t BTRFS_superblock_offsets[] = {
    BTRFS_SuperblockOffset0, BTRFS_SuperblockOffset1, BTRFS_SuperblockOffset2,
    BTRFS_SuperblockOffset3, 0};
...
typedef struct {
  ...
  /*Length in bytes of the (KEY, CHUNK_ITEM) table at the end of the
   * superblock*/
...
typedef struct { uint64_t end_offset; } BTRFS_LogItem;
